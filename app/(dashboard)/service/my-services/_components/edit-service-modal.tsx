...
interface EditServiceModalProps {
  isOpen: boolean;
  onClose: () => void;
  onEdit: (updatedService: ServiceItem) => void;
  serviceData: ServiceItem | null;
}

const getServiceFormData = (service: ServiceItem | null): ServiceFormData => ({
  title: service?.title ?? "",
...
export default function EditServiceModal({
  ...
  const [formData, setFormData] = useState<ServiceFormData>(() =>
    getServiceFormData(serviceData)
  );
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onEdit({ ...formData, id: serviceData.id });
    onClose();
  };
