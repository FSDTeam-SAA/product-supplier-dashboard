  ...
  const cards = data || [
    {
      id: "total_users",
      title: "Total Users",
      value: overview?.totalUsers !== undefined ? String(overview.totalUsers) : "1,160",
      color: "text-[#2B3087]",
    },
    {
      id: "revenue_month",
      title: "Revenue (month)",
      value:
        overview?.revenues !== undefined
          ? `$${Number(overview.revenues).toLocaleString()}`
          : "$8,820",
      color: "text-[#8E44AD]",
    },
    {
      id: "active_jobs",
      title: "Active Jobs",
      value: overview?.activeJobs !== undefined ? String(overview.activeJobs) : "220",
      color: "text-[#27AE60]",
    },
    {
      id: "pending_approvals",
      ...
      value:
        overview?.pendingApprovals !== undefined
          ? String(overview.pendingApprovals)
          : "16",
      color: "text-[#D4AC0D]",
    },
  ];
