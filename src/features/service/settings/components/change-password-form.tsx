...
import { useChangePassword } from "../hooks/useServiceSettings";
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 pt-6">
              <Button
                ...
                variant="outline"
                onClick={() => form.reset()}
                className="border-slate-300 text-slate-700 hover:bg-slate-100 font-medium text-xs h-9 px-6 bg-transparent cursor-pointer"
              >
                Cancel
              </Button>
              <Button
                ...
                className="bg-[#2b6ba8] hover:bg-[#205282] text-white font-medium text-xs h-9 px-6 transition-colors cursor-pointer"
              >
